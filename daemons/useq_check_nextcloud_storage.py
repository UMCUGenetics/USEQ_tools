from config import NEXTCLOUD_HOST,NEXTCLOUD_WEBDAV_ROOT,NEXTCLOUD_RUN_DIR,MAIL_SENDER, NEXTCLOUD_USER, NEXTCLOUD_PW, NEXTCLOUD_STORAGE, NEXTCLOUD_MAX,MAIL_SENDER,MAIL_ADMINS
...
def checkUsage():
	...
	if usage >= NEXTCLOUD_MAX:
		subject = 'NextCloud host {0} storage at {1}%!'.format(NEXTCLOUD_HOST, NEXTCLOUD_MAX)
